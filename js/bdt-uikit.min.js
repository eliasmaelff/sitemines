/*! bdtUIkit 3.19.1 | https://www.getuikit.com | (c) 2014 - 2024 YOOtheme | MIT License */ (function (
  ve,
  we
) {
  ...
  function es(t, e) {
    return T(
      T(t).map((i) => (i.hasChildNodes() ? ui(It(i.childNodes), e) : L(i, e)))
    );
  }
  function Ae(t) {
    T(t)
  ...
  function on(t) {
    vi(t) && rs(t, { func: "pauseVideo", method: "pause" }), mi(t) && t.pause();
  }
  function rn(t) {
  ...
  function xi(t, e) {
    return (
      e && (t.dataset.transition = 1 + xi(t)), $t(t.dataset.transition) || 0
    );
  }
  function In(t) {
    return Promise.all(
  ...
  function $a(t, e) {
    for (const { name: i, handler: s, immediate: n = !0 } of t._watches)
      ((t._initial && n) || (gt(e, i) && !ei(e[i], t[i]))) &&
        s.call(t, t[i], e[i]);
    t._initial = !1;
  }
  function ya(t) {
      ...
      methods: {
        ...
        showControls() {
          clearTimeout(this.controlsTimer),
            ...
            $(this.$el, "bdt-active", "bdt-transition-active");
        },
        hideControls() {
  ...
  var Do = {
    ...
    methods: {
      ...
      position() {
        ...
        (this.$el.hidden = !1),
          c(this.$el, "maxWidth", ""),
          this.$el.offsetWidth > s && $(this.$el, "bdt-drop-stack"),
  ...
  const Di = {
    ...
    kh = {
      ...
      beforeConnect() {
        const t =
          y(this.$el, "bdt-search-toggle") || y(this.$el, "bdt-navbar-toggle");
        if (
          ((this.icon = t
            ? "search-toggle-icon"
            : y(this.$el, "bdt-search-icon") &&
              oi(this.$el, ".bdt-search-large")
            ? "search-large"
            : oi(this.$el, ".bdt-search-navbar")
            ? "search-navbar"
            : this.$props.icon),
    ...
    Ch = {
      ...
      beforeConnect() {
        this.icon = `close-${
          y(this.$el, "bdt-close-large") ? "large" : "icon"
        }`;
      },
    },
    Th = { extends: Zt, i18n: { label: "Open" } },
    Eh = { extends: Zt, i18n: { label: "Back to top" } },
  ...
  var Bh = {
    ...
    observe: Fe({
      target: ({ $el: t, $props: e }) => [t, ...Ee(e.target, t)],
      handler(t, e) {
      ...
      read() {
        for (const t of this.target)
          si(
            t,
            "bdt-light,bdt-dark",
            !this.selActive || E(t, this.selActive) ? Wh(t) : ""
          );
      },
    },
  };
  ...
  var jh = {
      ...
      computed: {
        fill: ({ fill: t }, e) => t || c(e, "--bdt-leader-fill-content"),
      },
      connected() {
    ...
    Rh = {
      ...
      events: [
        ...
        },
        {
          ...
          self: !0,
          handler() {
            y(this.panel, "bdt-margin-auto-vertical")
              ? $(this.$el, "bdt-flex")
      ...
      observe: Fe({
        ...
        handler(t) {
          ...
          for (const { target: i, isIntersecting: s } of t) {
            e.has(i) ||
              e.set(i, { cls: X(i, "bdt-scrollspy-class") || this.cls });
            const n = e.get(i);
    ...
    nc = {
      ...
      connected() {
        (this.start = qo(this.start || this.top)),
          ...
          (this.placeholder =
            k("+ .bdt-sticky-placeholder", this.$el) ||
            k('<div class="bdt-sticky-placeholder"></div>')),
          (this.isFixed = !1),
          this.setActive(!1);
      },
      beforeDisconnect() {
  ...
  function Ns(t) {
    $(t, "bdt-transition-disable"),
      requestAnimationFrame(() => D(t, "bdt-transition-disable"));
  }
  var oc = {
    mixins: [Fo],
    args: "src",
  ...
  var Go = {
        ...
        },
        {
          ...
          el() {
            return this.connects.concat(
              this.itemNav ? Ee(this.itemNav, this.$el) : []
            );
          },
          delegate() {
            return `[${this.attrItem}],[data-${this.attrItem}]`;
    ...
    cc = {
      ...
      connected() {
        const t = y(this.$el, "bdt-tab-left")
          ? "bdt-tab-left"
          : y(this.$el, "bdt-tab-right")
          ? "bdt-tab-right"
          : !1;
        t &&
